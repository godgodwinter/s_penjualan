...
<button  class="btn btn-${datas[i].stoktersedia<1?'dark':'info'} addProduk" onclick="storeProduk(${datas[i].id},'${datas[i].nama}',${datas[i].harga_jual},${datas[i].stoktersedia})">Tambahkan Keranjang</button>
</div>
</div>
</div>
`;
